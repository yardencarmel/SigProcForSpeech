...
NFE$=8$, $s=-1.0$ yields a +67\,pp WER reduction over $s=+0.4$.
Note that Fig.\,3 of the base article reports results for 155\,M small
...
Our $s=-1$, NFE$=32$ result (WER\,=\,7.4\,\%, SIM-o\,=\,0.802) is the
